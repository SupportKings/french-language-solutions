...
### Entity Information
- **Entity Name**: Follow-up Sequences
- **Display Name**: Sequence Details
- **Main Field**: display_name
...
- Basic details of follow-up sequence

### Relationship Tabs (Tables with Add/Edit/Delete buttons)

#### Tab 1: [Relationship Name - e.g., "Associated Items"]
**What it shows:** Messages from template_follow_up_messages
**Empty message:** [What to show when no items exist]
**Table columns:**
- Create button should open modal/pop-up, component should be used for edit as well
- Step Index Should be Changed by Drag and Drop, not the separate column
- Time Delay with hours, shouldn't be edited from table preview, should be edited on modal/pop-up
- Message content should be edited on pop-up
- Table columns should be: status, time-delay, truncated message
