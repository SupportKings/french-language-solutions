...
export const classFormSchema = z.object({
	...
	mode: classModeEnum.default("online"),
	...
	max_students: z.number().int().positive("Must be a positive number").default(10),
	current_enrollment: z.number().int().min(0, "Cannot be negative").default(0),
