...
export const teacherFormSchema = z.object({
	...
	onboarding_status: onboardingStatusEnum.default("new"),
	google_calendar_id: z.string().optional(),
	maximum_hours_per_week: z.number().min(0).max(60).optional(),
	maximum_hours_per_day: z.number().min(0).max(12).optional(),
	qualified_for_under_16: z.boolean().default(false),
	available_for_booking: z.boolean().default(true),
	contract_type: contractTypeEnum.optional(),
	available_for_online_classes: z.boolean().default(true),
	available_for_in_person_classes: z.boolean().default(false),
