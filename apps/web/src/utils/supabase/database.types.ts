...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      cohort_messages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "cohort_messages_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: true
        ...
        Relationships: [
          {
            ...
            isOneToOne: false
            referencedRelation: "enrollment_full_view"
            referencedColumns: ["current_level_id_ref"]
          },
          {
            foreignKeyName: "cohorts_current_level_id_language_levels_id_fk"
            columns: ["current_level_id"]
            isOneToOne: false
            referencedRelation: "enrollment_full_view"
            referencedColumns: ["starting_level_id_ref"]
          },
          {
            foreignKeyName: "cohorts_current_level_id_language_levels_id_fk"
            columns: ["current_level_id"]
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "enrollment_full_view"
            referencedColumns: ["product_id_ref"]
          },
          {
            foreignKeyName: "cohorts_product_id_products_id_fk"
            columns: ["product_id"]
      ...
      students: {
        Row: {
          ...
          goal_language_level_id: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "students_goal_language_level_id_fkey"
            columns: ["goal_language_level_id"]
            isOneToOne: false
            referencedRelation: "enrollment_full_view"
            referencedColumns: ["current_level_id_ref"]
          },
    ...
    Views: {
      ...
      enrollment_full_view: {
        Row: {
          airtable_created_at: string | null
          airtable_record_id: string | null
          cohort_current_level_id: string | null
          cohort_id: string | null
          cohort_id_ref: string | null
          cohort_max_students: number | null
          cohort_name: string | null
          cohort_product_id: string | null
          cohort_room_type: Database["public"]["Enums"]["room_type"] | null
          cohort_start_date: string | null
          cohort_starting_level_id: string | null
          cohort_status: Database["public"]["Enums"]["cohort_status"] | null
          completion_percentage: number | null
          created_at: string | null
          current_level_code: string | null
          current_level_id_ref: string | null
          ...
          starting_level_code: string | null
          starting_level_id_ref: string | null
          ...
          transition_checklist: Json | null
          updated_at: string | null
          weekly_sessions: Json | null
        }
        Relationships: [
          {
            foreignKeyName: "cohorts_current_level_id_language_levels_id_fk"
            columns: ["cohort_current_level_id"]
            isOneToOne: false
            referencedRelation: "enrollment_full_view"
            referencedColumns: ["current_level_id_ref"]
          },
          ...
          {
            foreignKeyName: "cohorts_starting_level_id_language_levels_id_fk"
            columns: ["cohort_starting_level_id"]
            isOneToOne: false
            referencedRelation: "enrollment_full_view"
            referencedColumns: ["current_level_id_ref"]
          },
    ...
    Functions: {
      ...
      stop_active_follow_ups_for_student: {
    ...
    Enums: {
      announcement_scope: "school_wide" | "cohort"
      assessment_result:
        | "requested"
        | "scheduled"
        | "session_held"
