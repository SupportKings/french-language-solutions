...
export default function StudentDetailsClient({
  ...
  const saveAllChanges = async () => {
    try {
      ...
      if (
        editedStudent.goal_language_level_id !== student.goal_language_level_id
      ) {
      ...
      <div className="space-y-4 px-6 py-4">
        ...
        <div className="mt-6">
          <Tabs defaultValue="attendance" className="w-full">
            ...
            {/* Enrollments Tab - Hidden for teachers */}
            {!isTeacher && (
            ...
            {/* Assessments Tab - Hidden for teachers */}
            {!isTeacher && (
            ...
            {/* Reschedule Requests Tab - Hidden for teachers */}
            {!isTeacher && (
            ...
            {/* Follow-ups Tab - Hidden for teachers */}
            {!isTeacher && (
            ...
            {/* Touchpoints Tab - Hidden for teachers */}
            {!isTeacher && (
