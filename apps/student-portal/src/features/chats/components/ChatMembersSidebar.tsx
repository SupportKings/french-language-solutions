...
export function ChatMembersSidebar({
	...
	const displayData: DisplayData | undefined =
	...
	return (
		...
		>
			...
			<ScrollArea className="flex-1">
				...
				{/* Students Section - Only show for cohorts, not direct conversations */}
				{!conversationId && students.length > 0 && (
					<div className="py-2">
						<div className="px-4 py-2 font-semibold text-muted-foreground text-xs uppercase tracking-wider">
