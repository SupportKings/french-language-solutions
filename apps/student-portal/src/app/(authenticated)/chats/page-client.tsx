...
import { NewConversationDialog as NewConversationDialogComponent } from "@/features/chats/components/NewConversationDialog";
...
export function ChatsPageClient({
	...
	// Create conversation handler (student-specific)
	const {
		execute: executeCreateConversation,
		isPending: isCreatingConversation,
	} = useAction(createOrGetConversationForStudent, {
		onSuccess: ({ data }) => {
	...
	const handleCreateConversation = async (teacherUserIds: string[]) => {
		await executeCreateConversation({ teacherUserIds });
	};
