...
### Entity Information
- **Entity Name**: Enrollment Details
- **Display Name**: Enrollment Details
- **Main Field**: Student - Cohort's Linked Product
- **Navigation**: admin/students/enrollment/[id]
...
**Fields to show and edit:**
- Basic details (e.g name, phone number, email)

#### Section 2: Cohort Details
- Linked product details 
- Starting and Current Level if there is
- Weekly Sessions and Linked Teachers to these sessions
